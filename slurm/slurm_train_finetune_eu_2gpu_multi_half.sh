#!/bin/bash
#SBATCH --job-name=styletts2_ft_eu_2gpu_multi_half
...
#SBATCH --output=logs/styletts2_ft_eu_2gpu_multi_half.%j.out
#SBATCH --error=logs/styletts2_ft_eu_2gpu_multi_half.%j.err
...
python train_finetune_eu.py -p Configs/config_ft_eu_multi_half_2gpu.yml